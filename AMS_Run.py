...
window = tk.Tk()
window.title("MARK YOUR PRESENCE")
...
def manually_fill():
    ...
    SUB = tk.Label(sb, text="Enter Subject", width=15, height=2, fg="white", bg="blue", font=('times', 15, ' bold '))
    SUB.place(x=30, y=100)

    global SUB_ENTRY

    SUB_ENTRY = tk.Entry(sb, width=20, bg="gray", fg="black", font=('times', 23, ' bold '))
...
def subjectchoose():
    ...
    sub = tk.Label(windo, text="Enter Subject", width=15, height=2, fg="white", bg="blue1", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)

    tx = tk.Entry(windo, width=20, bg="gray", fg="black", font=('times', 23, ' bold '))
...
def admin_panel():
    ...
    un_entr = tk.Entry(win, width=20, bg="gray", fg="black", font=('times', 23, ' bold '))
    un_entr.place(x=290, y=55)

    def c11():
        pw_entr.delete(first=0, last=22)

    pw_entr = tk.Entry(win, width=20,show="*", bg="gray", fg="black", font=('times', 23, ' bold '))
    ...
    Login = tk.Button(win, text="LogIn", fg="white", bg="blue2", width=20,
                       height=2,
                       activebackground="Gray",command=log_in, font=('times', 15, ' bold '))
    Login.place(x=328, y=250)
    win.mainloop()
...
message = tk.Label(window, text="MARK YOUR PRESENCE", bg="snow", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2, fg="white", bg="black", font=('times', 15, ' bold '))
...
txt = tk.Entry(window, validate="key", width=20, bg="gray", fg="black", font=('times', 25, ' bold '))
...
txt2 = tk.Entry(window, width=20, bg="gray", fg="black", font=('times', 25, ' bold '))
...
clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="white"  ,bg="black"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
